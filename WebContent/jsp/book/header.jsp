...
<div class="head">
							...
							<c:otherwise>
								<div class="btn-group adminName top-right">
									...
									<ul class="dropdown-menu dropdown-menu-right">
									    ...
									    <li><a href="#">我的资料</a></li>
									    <li><a style="border-top:1px #ccc solid" href="UserServlet?action=off" onClick="return confirm('确定退出登录吗？')">退 出 登 录</a></li>
									</ul>
								</div>
							</c:otherwise>
						</c:choose>
			...
			<div class="mid container">
				<div class="row">
					<a class="logo col-md-5" href="jsp/book/index.jsp" title="网上书城">
